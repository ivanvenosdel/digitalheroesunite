...
{
    public class ActionManActor : Actor
    {
        #region Constructors
        public ActionManActor(Guid id)
            : base(id, ActorType.ACTIONMAN)
        {
        }
        #endregion
        ...
        public void Initialize(Vector2 pos)
        {
            ...
            string filepath = @"Actors\ActionMan\";
            string[] animations = { filepath + "ActionMan" };
